            ...
            EddyTheme {
                ...
                Scaffold { padding ->
                    Column(
                        ...
                        Text(
                            text = "Conectá EDDY con Home Assistant usando la dirección local y un token de larga duración. Los datos quedan guardados solo en este teléfono.",
                        ...
                        if (saved) {
                            Spacer(Modifier.height(12.dp))
                            Text("Listo. Ya podés decir: “EDDY, apagá la luz de la sala”.")
                        }
                    }
                }
            }
