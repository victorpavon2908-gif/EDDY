package com.eddy.assistant.selfupgrade
...
/**
 * Diario local de evolución de EDDY. Guarda propuestas, pruebas y rollback.
 ...
 */
class EddySelfUpgradeManager(context: Context) {
    private val root = File(context.applicationContext.filesDir, "eddy-evolution").apply { mkdirs() }
