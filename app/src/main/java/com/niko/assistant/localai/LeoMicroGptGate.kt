...
object LeoMicroGptGate {
    ...
    fun classify(input: String): Family? {
        ...
        if (containsAny(text, "sin internet", "sin wifi", "sin datos", "offline", "sin conexion", "sin groq", "sin groqcloud")) return Family.OFFLINE
        ...
        if (containsAny(text, "como nica", "como nicaraguense", "voseo", "mas tuani", "palabras de nicaragua")) return Family.NICARAGUAN_STYLE
        ...
        if (text.startsWith("hola") || text.startsWith("buenas") || text.startsWith("buen dia") || text.startsWith("hey leo") || text.startsWith("ey leo") || text == "que tal") return Family.GREETING
        return null
    }
