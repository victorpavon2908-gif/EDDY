...
class GroqConversationTest {
    ...
    @Test fun searchRestrictsCompoundToWebAndRequestsCitations() {
        val base = GroqConversation.payload("Qué noticias hay", "tono acústico suave", emptyList(), true, EddyPersonality.DIRECT)
        ...
        assertTrue(system.contains(EddyPersonality.DIRECT.guidance()))
